...
public class SwipableRecyclerAdapter<T extends StorageObject> extends SortableRecyclerAdapter<T> {
     ...
     * </p><p>
     * </p><p>set inCompoundAdapter to true if it is created from within {@link com.nepumuk.notizen.core.views.adapters.CompoundAdapter} or shall be used in one
     * </p><p>if either leftSwipeMenu or rightSwipeMenu are set to {@link com.nepumuk.notizen.core.R.layout#swipable_empty}, the menu is ignored
     * @param itemList
     * @param SortOrder
