...
public class Setting {
     ...
     */
    private static Setting SettingsSingleton = new Setting();
     ...
     * @param context
     */
    public void init (Context context)throws SettingException {
        // save context
        ...
        try {
            ...
            throw new SettingException(SettingException.aINIT_SETTINGS_FAILED,e);
        }
    }
     ...
     */
    private void initPrefs(boolean bResetExistingSettings) throws SettingException {
        try {
            ...
            throw new SettingException(SettingException.aINIT_PREFS_FAILED,ex);
        }
    }
     ...
     * @throws SettingException in case of incompatible type was given
     */
    public void setSetting (String key, Object value) throws SettingException {
        ...
        if (value instanceof Integer) {
            ...
            throw new SettingException(SettingException.aSETTING_VALUE_FAILED,null);
        }
        // apply changes
        prefEditor.apply();
    }
